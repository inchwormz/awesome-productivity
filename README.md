...
- [PeakFlow](https://getpeakflow.pro) - Free, open-source Windows productivity suite with screen dimming, clipboard manager, volume mixer, Pomodoro timer, and meeting alerts. Built with Electron.
